...
![imeges hosting.png](assets/imeges%20hosting.png)
...
![imeges hosting 2.png](assets/imeges%20hosting%202.png)
...
```bash
git clone git@github.com:Sergii-Muraviov/group6_image_hosting_server.git
